...
class ObjectPainter(object):
    ...
    def Drawxxx(self):
        pts=[]
        pts.append(pya.DPoint(-206684,-225000))
        pts.append(pya.DPoint(-206684,-7000))
        pts.append(pya.DPoint(-236739,-7000))
        pts.append(pya.DPoint(-236739,3000))
        pts.append(pya.DPoint(-206684,3000))
        pts.append(pya.DPoint(-206684,225000))
        pts.append(pya.DPoint(108316,225000))
        pts.append(pya.DPoint(160851,130000))
        pts.append(pya.DPoint(228316,8000))
        pts.append(pya.DPoint(236740,8000))
        pts.append(pya.DPoint(236740,4000))
        pts.append(pya.DPoint(228316,4000))
        pts.append(pya.DPoint(108316,125000))
        pts.append(pya.DPoint(-141684,125000))
        pts.append(pya.DPoint(-141684,-125000))
        pts.append(pya.DPoint(108316,-125000))
        pts.append(pya.DPoint(228316,-4000))
        pts.append(pya.DPoint(236740,-4000))
...
painter1=paintlib.CavityPainter(pya.DPoint(0,0),pya.DPoint(0,4000))
painter1.Straight(1000000)
painter1.Turning(-500000)
painter1.Turning(-500000)
painter1.Straight(1000000)
painter1.Turning(500000)
painter1.Turning(500000)

painter1.pointr=pya.DPoint(0,8000)
painter1.pointl=pya.DPoint(0,12000)
painter1.Straight(1000000)
painter1.Turning(-500000+8000)
painter1.Turning(-500000+8000)
painter1.Straight(1000000)
painter1.Turning(500000+8000)
painter1.Turning(500000+8000)
