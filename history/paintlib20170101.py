...
#画腔
painter3=paintlib.CavityPainter(pya.DPoint(0,0),pya.DPoint(0,16000))#初始化腔的Painter
painter3.pointdistance=500#设置腔的精度
painter3.Turning=painter3.TurningInterpolation

painter3.Straight(1000000)#画外轮廓
...
painter3.Setpoint(pya.DPoint(0,4000),pya.DPoint(0,12000))#画内轮廓
painter3.Straight(1000000)#(和外轮廓是一样的代码)
painter3.Turning(-400000)
painter3.Turning(-400000)
painter3.Straight(1000000)
painter3.Turning(400000)
...
paintlib.BasicPainter.Output(cell2,layer1,region1-region2)#把画好的腔置入

centerlinelist=[]#画腔的中心线并根据中心线画Airbridge
centerlinelist.append(painter3.Getcenterline())
painter4=paintlib.TransfilePainter("[Airbridge].gds","insert")
painter4.airbridgedistance=100000#设置Aibridge的间距
