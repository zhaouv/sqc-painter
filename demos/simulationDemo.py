...
painter4 = paintlib.CavityPainter(
    pya.DPoint(-1300000, -300000), angle=90, widout=20000, widin=10000, bgn_ext=0, end_ext=0)
...
Simulation.create(
    ...
    region=painter5.region, brush=painter5.brush, transmissionlines=[
        c4], portbrushs=None,
